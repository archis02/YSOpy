...
def run_optimization(poly_order):
    ...
    result = least_squares(residuals_polynomial, INITIAL_GUESS_TOT, args=(poly_order,), method='trf', bounds=BOUNDS, verbose=2, xtol=1e-8, ftol=1e-8, diff_step=[3e-2,1e-2,5e-3,1e-3,1e-3,1e-5])#,1e-3])
